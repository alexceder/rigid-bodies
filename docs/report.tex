...
%-- Abstract
\begin{abstract}
This report will cover the thought process of creating a physics simulation of collision impulses for basic geometries.
\end{abstract}
...
We thought that it was a bit too easy. Maybe we should have challenged ourselves a bit more.
